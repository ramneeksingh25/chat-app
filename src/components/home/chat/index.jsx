  ...
  return (
    <div className='h-[98vh] p-3 shadow-xl rounded-xl bg-zinc-200/10 dark:bg-zinc-800/40 backdrop-blur-30'>
      ...
      <div className="inline-block w-full text-center font-extrabold p-2 pb-5 m-0">
        <h1 className="mb-4 text-3xl bg-gradient-to-l from-blue-700 to-purple-700 text-transparent bg-clip-text underline hover:from-blue-6 cursor-auto 00 hover:to-purple-600">ChatSpot - Chat, Share, Connect</h1>
