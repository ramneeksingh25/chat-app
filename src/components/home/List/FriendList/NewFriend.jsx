...
const NewFriend = () => {
	...
	return (
		<div
			className="w-96 text-3xl text-indigo-800 dark:text-indigo-300 select-none space-y-2 p-6 shadow-xl rounded-xl bg-zinc-200/30 dark:bg-zinc-800/80 backdrop-blur-30"
			onKeyDown={(e) => {
				if (e.key === "Enter") {
					findFriend();
				}
			...
			<div className="flex flex-col gap-0">
				<label className="text-xl mb-0 font-bold underline decoration-pink-500/70 hover:decoration-indigo-700/70 transition duration-500">
					Email
				</label>
				<input
					type="Name"
